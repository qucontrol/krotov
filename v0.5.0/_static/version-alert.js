...
function getRootUrl() {
  ...
  // (getCurrentFolder). On gh-pages, this includes the project name.
...
function _addVersionsMenu(version_data) {
  ...
  var current_folder = getCurrentFolder()
  ...
  var inner_html =
    "<span class='rst-current-version' data-toggle='rst-current-version'>" +
      "<span class='fa fa-book'> Doctr</span> " + current_version + " " +
  ...
  var inner_html = inner_html +
        "</dl>" +
        "<hr>" +
        "<small>Generated by <a href='https://drdoctr.github.io'>Doctr</a>" +
        "</small>" +
      "</div>" +
    "</div>";
...
function addVersionsMenu() {
  ...
  var json_file = "/" + window.location.pathname.split('/')[1]
                  + "/versions.json";
