...
.venv/py35/bin/py.test:
	...
	@conda install -y --override-channels -c defaults -c conda-forge -p .venv/py35 'qutip=4.4.1'
...
.venv/py36/bin/py.test:
	...
	@# if the conda installation does not work, simply comment out the following line, and let pip handle it
	@conda install -y --override-channels -c defaults -c conda-forge -p .venv/py36 'qutip=4.4.1'
...
.venv/py37/bin/py.test:
	...
	@# if the conda installation does not work, simply comment out the following line, and let pip handle it
	@conda install -y --override-channels -c defaults -c conda-forge -p .venv/py37 'qutip=4.4.1'
